...
<style>
        * {
        ...
        .container {
            ...
            background: white;
            border-radius: 20px;
            box-shadow: 0 10px 10px rgba(245, 240, 240, 0.5);
            overflow: hidden;
            width: 800px;
            max-width: 90%;
        }
...
.ms-3:hover {
    ...
    color: #003d5c; /* Darker blue text color on hover */
...
.flex-items-center-justify-end-mt-{
    color: white;
}
        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white;"> --}}
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    ...
                    @else
                    <a href="{{ route('login') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white "></a>
                ...
                <div class="right-panel">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex-items-center-justify-end mt-">
                         ...
                         <a class="underline text-sm text-white hover:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('password.request') }}">
                          {{ __('lupa sandi?') }}
                             </a>
                             @endif
                            ...
                            style="background-color:white; border-radius: 15px; height: 50px; width: 150px; padding: 10px 0; display: flex; justify-content: center; align-items: center; color:#005c8b; font-weight: bold; ">
                                {{ __('Login') }}
                            </x-primary-button>
